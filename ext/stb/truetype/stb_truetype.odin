...
import c "core:c"
import stbrp "ext:stb/rectpack"

// @(private)
// LIB :: (
// 	     "stb_truetype.lib"      when ODIN_OS == .Windows
// 	else "stb_truetype.a"        when ODIN_OS == .Linux
// 	else "darwin/stb_truetype.a" when ODIN_OS == .Darwin
// 	else ""
// )

when      ODIN_OS == .Windows do LIB :: "stb_truetype.lib"
else when ODIN_OS == .Linux   do LIB :: "stb_truetype.a"
else when ODIN_OS == .Darwin 	do LIB :: "stb_truetype_macos.a"
