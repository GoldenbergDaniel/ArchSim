...
when ODIN_OS == .Windows {
  ...
  when USE_GL {
    when ODIN_ARCH == .arm64 {
      when DEBUG { foreign import sokol_app_clib { "../libsokol.a", "system:Cocoa.framework","system:QuartzCore.framework","system:OpenGL.framework" } }
      else       { foreign import sokol_app_clib { "../libsokol.a", "system:Cocoa.framework","system:QuartzCore.framework","system:OpenGL.framework" } }
    }
    else {
      when DEBUG { foreign import sokol_app_clib { "../libsokol.a", "system:Cocoa.framework","system:QuartzCore.framework","system:OpenGL.framework" } }
      else       { foreign import sokol_app_clib { "../libsokol.a", "system:Cocoa.framework","system:QuartzCore.framework","system:OpenGL.framework" } }
